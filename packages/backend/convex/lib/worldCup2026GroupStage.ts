...
export const seededGroupStageTeams: SeededTeam[] = [
  { code: "MEX", name: "Mexico", flagEmoji: "🇲🇽", groupCode: "A", worldRanking: 15, isHost: true },
  { code: "RSA", name: "South Africa", flagEmoji: "🇿🇦", groupCode: "A", worldRanking: 61 },
  { code: "KOR", name: "South Korea", flagEmoji: "🇰🇷", groupCode: "A", worldRanking: 22 },
  { code: "CZE", name: "Czech Republic", flagEmoji: "🇨🇿", groupCode: "A" },
  { code: "CAN", name: "Canada", flagEmoji: "🇨🇦", groupCode: "B", worldRanking: 27, isHost: true },
  { code: "BIH", name: "Bosnia and Herzegovina", flagEmoji: "🇧🇦", groupCode: "B" },
  { code: "QAT", name: "Qatar", flagEmoji: "🇶🇦", groupCode: "B", worldRanking: 51 },
  { code: "SUI", name: "Switzerland", flagEmoji: "🇨🇭", groupCode: "B", worldRanking: 17 },
  { code: "BRA", name: "Brazil", flagEmoji: "🇧🇷", groupCode: "C", worldRanking: 5 },
  { code: "MAR", name: "Morocco", flagEmoji: "🇲🇦", groupCode: "C", worldRanking: 11 },
  { code: "HAI", name: "Haiti", flagEmoji: "🇭🇹", groupCode: "C", worldRanking: 84 },
  { code: "SCO", name: "Scotland", groupCode: "C", worldRanking: 36 },
  { code: "USA", name: "United States", flagEmoji: "🇺🇸", groupCode: "D", worldRanking: 14, isHost: true },
  ...
  { code: "TUR", name: "Turkey", flagEmoji: "🇹🇷", groupCode: "D" },
  { code: "GER", name: "Germany", flagEmoji: "🇩🇪", groupCode: "E", worldRanking: 9 },
  { code: "CUW", name: "Curaçao", flagEmoji: "🇨🇼", groupCode: "E", worldRanking: 82 },
  { code: "CIV", name: "Ivory Coast", flagEmoji: "🇨🇮", groupCode: "E", worldRanking: 42 },
  { code: "ECU", name: "Ecuador", flagEmoji: "🇪🇨", groupCode: "E", worldRanking: 23 },
  { code: "NED", name: "Netherlands", flagEmoji: "🇳🇱", groupCode: "F", worldRanking: 7 },
  { code: "JPN", name: "Japan", flagEmoji: "🇯🇵", groupCode: "F", worldRanking: 18 },
  { code: "SWE", name: "Sweden", flagEmoji: "🇸🇪", groupCode: "F" },
  { code: "TUN", name: "Tunisia", flagEmoji: "🇹🇳", groupCode: "F", worldRanking: 40 },
  { code: "BEL", name: "Belgium", flagEmoji: "🇧🇪", groupCode: "G", worldRanking: 8 },
  { code: "EGY", name: "Egypt", flagEmoji: "🇪🇬", groupCode: "G", worldRanking: 34 },
  { code: "IRN", name: "Iran", flagEmoji: "🇮🇷", groupCode: "G", worldRanking: 20 },
  { code: "NZL", name: "New Zealand", flagEmoji: "🇳🇿", groupCode: "G", worldRanking: 86 },
  { code: "ESP", name: "Spain", flagEmoji: "🇪🇸", groupCode: "H", worldRanking: 1 },
  { code: "CPV", name: "Cape Verde", flagEmoji: "🇨🇻", groupCode: "H", worldRanking: 68 },
  { code: "KSA", name: "Saudi Arabia", flagEmoji: "🇸🇦", groupCode: "H", worldRanking: 60 },
  { code: "URU", name: "Uruguay", flagEmoji: "🇺🇾", groupCode: "H", worldRanking: 16 },
  { code: "FRA", name: "France", flagEmoji: "🇫🇷", groupCode: "I", worldRanking: 3 },
  { code: "SEN", name: "Senegal", flagEmoji: "🇸🇳", groupCode: "I", worldRanking: 19 },
  { code: "IRQ", name: "Iraq", flagEmoji: "🇮🇶", groupCode: "I" },
  { code: "NOR", name: "Norway", flagEmoji: "🇳🇴", groupCode: "I", worldRanking: 29 },
  { code: "ARG", name: "Argentina", flagEmoji: "🇦🇷", groupCode: "J", worldRanking: 2 },
  { code: "ALG", name: "Algeria", flagEmoji: "🇩🇿", groupCode: "J", worldRanking: 35 },
  { code: "AUT", name: "Austria", flagEmoji: "🇦🇹", groupCode: "J", worldRanking: 24 },
  { code: "JOR", name: "Jordan", flagEmoji: "🇯🇴", groupCode: "J", worldRanking: 66 },
  { code: "POR", name: "Portugal", flagEmoji: "🇵🇹", groupCode: "K", worldRanking: 6 },
  { code: "COD", name: "DR Congo", flagEmoji: "🇨🇩", groupCode: "K" },
  { code: "UZB", name: "Uzbekistan", flagEmoji: "🇺🇿", groupCode: "K", worldRanking: 50 },
  { code: "COL", name: "Colombia", flagEmoji: "🇨🇴", groupCode: "K", worldRanking: 13 },
  { code: "ENG", name: "England", groupCode: "L", worldRanking: 4 },
  { code: "CRO", name: "Croatia", flagEmoji: "🇭🇷", groupCode: "L", worldRanking: 10 },
...
export function buildSeededGroupStageMatches(): SeededGroupStageMatch[] {
  return seededGroupStageMatchSources.map((match) => ({
    ...
    stageLabel: `Group ${match.groupCode}`,
    status: "scheduled",
  }));
}
